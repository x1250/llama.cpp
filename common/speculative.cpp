...
struct common_speculative_impl_draft_mtp : public common_speculative_impl {
    ...
    bool process(const llama_batch & batch_in) override {
        ...
        // the target extracts its nextn rows unmasked (dense, one row per token of the batch): read once,
        // with the one synchronization of the target, and address the rows by token index
