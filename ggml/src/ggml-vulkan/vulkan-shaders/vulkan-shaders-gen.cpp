...
void matmul_shaders(bool fp16, MatMulIdType matmul_id_type, bool coopmat, bool coopmat2, bool f16acc, bool dot2 = false) {
    ...
    for (const auto& tname : type_names) {
        ...
        if ((tname == "q1_0") || (tname == "q4_0") || (tname == "q4_1") || (tname == "q5_1") || (tname == "iq1_s") || (tname == "iq1_m") || (tname == "iq2_xxs") || (tname == "iq2_xs") || (tname == "iq2_s"))
            load_vec_quant = "8";
        else if ((tname == "q2_0") || (tname == "q5_0") || (tname == "q8_0") || (tname == "q2_k") || (tname == "q4_k") || (tname == "q5_k") || (tname == "iq3_xxs") || (tname == "iq4_xs") || (tname == "iq4_nl") || (tname == "mxfp4") || (tname == "nvfp4"))
            load_vec_quant = "4";

        // iq3_s: 4, 8 or 16 values per load (mul_mm_funcs.glsl has the three paths)
        if (tname == "iq3_s") {
            load_vec_quant = "16";
        }
        ...
        if (!f16acc && !coopmat && !coopmat2 && !dot2 && (is_legacy_quant(tname) || is_k_quant(tname) || tname == "mxfp4" || tname == "iq4_nl")) {
...
void process_shaders() {
...
#if defined(GGML_VULKAN_INTEGER_DOT_GLSLC_SUPPORT)
        if (is_legacy_quant(tname) || tname == "mxfp4" || is_k_quant(tname) || tname == "iq1_s" || tname == "iq1_m" || tname == "iq4_nl") {
    ...
    string_to_spv("fa_sparse_list", "flash_attn_sparse_list.comp", {});
    ...
    string_to_spv("hc_gated_mean_f32", "hc_gated_mean.comp", {{"A_TYPE", "float"}});
    string_to_spv("hc_inject_f32",     "hc_inject.comp",     {{"A_TYPE", "float"}});
...
void write_output_files() {
    ...
    for (const auto& tname : type_names) {
        if (btype == "q8_1" && !is_legacy_quant(tname) && tname != "mxfp4" && !is_k_quant(tname) && tname != "iq1_s" && tname != "iq1_m" && tname != "iq4_nl") {
            continue;
        }
