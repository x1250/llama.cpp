...
void ggml_compute_forward_hc_gated_mean(const struct ggml_compute_params * params, struct ggml_tensor * dst);
void ggml_compute_forward_hc_inject(const struct ggml_compute_params * params, struct ggml_tensor * dst);
